...
pub mod util {
    ...
    pub fn open_term_agent_pipe(term_agent_pipe_name: &str) -> IO<PathBuf> {
    ...
    pub fn get_page_tmp_dir() -> IO<PathBuf> {
    ...
    #[allow(dead_code)]
    pub fn wait_until_file_created(file_path: &PathBuf) -> IO {
    ...
    #[allow(dead_code)]
    pub fn random_unique_string() -> String {
